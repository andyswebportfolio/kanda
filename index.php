		...
		<body>
			...
			<div class="nav">
				...
				<div class="mainBar">
					...
					<p><a href="#galleryNavPosition">Gallery</a></p>
					...
					<div id="contactDetails">
						<p>
						Tel: 01323 325566 or 07834 170928<br>
						Email: kahairandbeauty@gmail.com
						</p>
			...
			<br>
			<div class="fullWidth" id="gallery">
				<h1>Gallery</h1>
				<!--<iframe id="embedSocial" src="http://embedsocial.com/facebook_album/album_photos/1077606882316739" width="100%" height="2000" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" allowfullscreen></iframe>-->
				<div class='embedsocial-album' data-ref="864fbdbe12ede32ff483db9dba5d326e8a53a915"></div><script>(function(d, s, id){var js; if (d.getElementById(id)) {return;} js = d.createElement(s); js.id = id; js.src = "https://embedsocial.com/embedscript/ei.js"; d.getElementsByTagName("head")[0].appendChild(js);}(document, "script", "EmbedSocialScript"));</script>
				...
				<div class="equalDistanceX">
					...
					<div class="unevenBoxSmallR">
						...
						<div class="boxContentText">
							...
							56 Susans Road<br>									BN21 3TG<br>
							Eastbourne<br><br>
							</p>
							<p>Tel: 01323 325566<br>
                                Mobile: 07834 170928<br>
							Email: kahairandbeauty@gmail.com
							...
							Opening Hours<br><br>
							Monday | Closed<br>
							Tuesday | 9:00am &hyphen; 5:00pm<br>
							Wednesday | 9:00am &hyphen; 5:00pm<br>
							Thursday | 9:00am &hyphen; 6:00pm<br>
							Friday | 9:00am &hyphen; 9:00pm<br>
							Saturday | 9:00am &hyphen; 5:00pm<br>
							Sunday | Closed<br>
							</p>
						</div>
					</div>
					...
					<iframe id="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2523.2708578659162!2d0.2849042157430231!3d50.77055237952092!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47df73f070fbb9c9%3A0xef067dc505a753b0!2s56+Susans+Rd%2C+Eastbourne+BN21+3TG!5e0!3m2!1sen!2suk!4v1492419403816" frameborder="10" style="border:0"> </iframe>
			...
			<!--<div class="divide">
					...
					<div class="unevenBoxSmallR">
						<div class="boxContentImage">
							...
							<a href="https://www.facebook.com/kahairandbeauty/?hc_ref=SEARCH"><img class="social" src="icon/facebookI
								con.png" alt="facebook logo"></a>
						</div>
						<div class="boxContentImage">
							<a href="https://twitter.com/KAHairAndBeauty"><img class="social" src="icon/twitterIcon.png" alt="twitter logo"></a>
						</div>
						<div class="boxContentImage">
							<a href="https://www.instagram.com/ka_hair_and_beauty/"><img class="social" src="icon/instagramIcon.png" alt="instagram logo"></a>
						</div>
					</div>
						<div class="boxContentText">

							<p>This Site &copy; K and A Hair and Beauty 2017<br><br>
							Web Design and Development by<br> <a href="http://www.awkwebdesign.com">AWK Web Design</a>
							</p>
						</div>
